...
export default async function ResetPasswordPage({
  ...
  if (!user) {
    redirect('/forgot-password?error=Your password reset link is invalid or has expired. Please request a new one.')
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8F7F4] px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-semibold text-gray-900 tracking-tight">Set New Password</h1>
