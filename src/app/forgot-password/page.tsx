...
import { ArrowLeft, ArrowRight, Gavel, Mail } from 'lucide-react'
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
          <form className="space-y-6" action={requestPasswordReset}>
            {resolvedSearchParams?.message && (
              <div className="p-4 bg-green-50 text-green-800 text-sm rounded-xl border border-green-200 flex items-start gap-3">
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            ...
            <Link href="/login" className="font-medium text-indigo-600 hover:text-indigo-700 inline-flex items-center gap-1">
